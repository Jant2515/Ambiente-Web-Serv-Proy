...
<body>
    <form role="form" action="" method="post">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="pogoSlider" id="js-main-slider">
                        <div class="pogoSlider-slide" style="background-image:url(View/images/dinero.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="slide_text white_fonts">
                                            ...
                                            <br>
                                            <a class="start_exchange_bt" href="View/servicios.php">Servicios></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="pogoSlider-slide" style="background-image:url(View/images/monedas.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="slide_text white_fonts">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="full text_align_right_img">
                            <img src="View/images/bancofoto.jpg" alt="#" />
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="full services_blog">
                            <img class="img-responsive" src="View/images/seguridad1.jpg" alt="#" />
                            <h4>Seguridad</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="full services_blog">
                            <img class="img-responsive" src="View/images/appmovil.jpg" alt="#" />
                            <h4>Aplicación móvil</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="full services_blog">
                            <img class="img-responsive" src="View/images/cuenta.jpg" alt="#" />
                            <h4>Cuenta</h4>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="full services_blog">
                            <img class="img-responsive" src="View/images/soporte.png" alt="#" />
                            <h4>Soporte</h4>
                        </div>
                    </div>
                </div>
                <div class="row margin-top_30">
                    <div class="col-sm-12">
                        <div class="full">
                            <div class="center">
                                <a class="main_bt" href="View/servicios.php">Más Servicios</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            <img class="img-responsive" src="View/images/euro-vs-dolar.jpg" alt="#" />
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            <img class="img-responsive" src="View/images/estafa.jpg" alt="#" />
                            <div class="overlay"><a class="main_bt transparent" href="#">Ver Más</a></div>
                            <div class="blog_details">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="full news_blog">
                            <img class="img-responsive" src="View/images/inflacion.jpg" alt="#" />
                            <div class="overlay"><a class="main_bt transparent" href="#">Ver Más</a></div>
                            <div class="blog_details">
        ...
        <script src="View/js/jquery.pogo-slider.min.js"></script>
        <script src="View/js/slider-index.js"></script>
</body>
